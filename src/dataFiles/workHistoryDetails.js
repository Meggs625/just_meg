...
const workHistoryData = [
    ...
    },
    {
        ...
        mainProject: "Collaborating with the UX/UI design team, we began to create an internal design system. Utilizing the designs they created in Figma, we used the React Aria library to create accessible and beautiful components. During the project, we also utilized Storybook to be able to test and track the changes made for each component variant as they were being created. I completed over 5 component transitions and their accompanying stories including all buttons and dropdowns.",
        otherDetails: {
            workEnvironment: "Remote",
            teamSize: "This was a small startup environment with one other very experienced frontend developer and two person UX/UI team and a sizeable backend team.",
            tickets: "Initially, tickets were managed with GitHub Projects, but moved to Jira shortly before my departure. Included a good amount of detail, wireframes, and mockups"
        },
        otherExperiences: [
    ...
    },
    {
        ...
        otherDetails: {
            ...
            teamSize: "Team size was generally between 20-30 analysts",
            tickets: "Tasks and tickets varied wildly with my different titles",
        },
        otherExperiences: [
